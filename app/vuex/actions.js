...
export const filter_subscriptions = function(store, {all_users=false, term=null, exclude=null, offset=0, limit=20}={}) {
    return new Promise((resolve, reject) => {
        ...
        store.control
             .filter_subscriptions(all_users, term, exclude, offset, limit)
             .then(handle_success)
             .catch(handle_error)
    })
}
