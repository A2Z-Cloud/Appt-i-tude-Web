...
deploy:
	...
	aws cloudfront create-invalidation --profile a2zcloud --distribution-id E3F4M5LFOJTS3H --invalidation-batch "{\"Paths\": {\"Quantity\": 1,\"Items\": [\"/*\"]},\"CallerReference\": \"make deploy\"}"
